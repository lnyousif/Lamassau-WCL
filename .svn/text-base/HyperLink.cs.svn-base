...
namespace Lamassau.Web.UI.WebControls
{
	...
	/// <summary>
	/// HyperLink: Inherting the HyperLink ASP.NET control;
	/// Designed by Laith N Yousif.
	/// Developed by Laith N Yousif. 
	/// Date: Jan 2006.
	/// </summary>
	[ToolboxData("<{0}:HyperLink runat=server></{0}:HyperLink>"), PermissionSet(SecurityAction.Demand, Unrestricted=true)]
	[DesignerAttribute(typeof(HyperLinkControlDesigner))]
	public class HyperLink: System.Web.UI.WebControls.HyperLink,ILamassauControl 
	{
	...
	namespace Design 
	{
		public class HyperLinkControlDesigner  : HyperLinkDesigner  
		{
...
//				{
//				
//					HyperLink DesignHyperLink = (HyperLink) Component;
//
//					// Capture the default output of the HyperLink control
//					StringWriter writer = new StringWriter();
//					HtmlTextWriter buffer = new HtmlTextWriter(writer);
//					DesignHyperLink.RenderControl(buffer);			
