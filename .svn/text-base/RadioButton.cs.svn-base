...
namespace Lamassau.Web.UI.WebControls
{
	...
	/// <summary>
	/// RadioButton: Inherting the RadioButton ASP.NET control;
	/// Designed by Laith N Yousif.
	/// Developed by Laith N Yousif. 
	/// Date: Jan 2006.
	/// </summary>
	[ToolboxData("<{0}:RadioButton runat=server></{0}:RadioButton>"), PermissionSet(SecurityAction.Demand, Unrestricted=true)]
//	[DesignerAttribute(typeof(RadioButtonControlDesigner))]
	public class RadioButton: System.Web.UI.WebControls.RadioButton,ILamassauControl 
	{
...
//	namespace Design 
//	{
//		public class RadioButtonControlDesigner : RadioButtonDesigner
//		{
//	      
...
////				{
////				
////					RadioButton DesignRadioButton = (RadioButton) Component;
////
////					// Capture the default output of the RadioButton control
////					StringWriter writer = new StringWriter();
////					HtmlTextWriter buffer = new HtmlTextWriter(writer);
////					DesignRadioButton.RenderControl(buffer);			
