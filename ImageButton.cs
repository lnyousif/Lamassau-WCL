...
namespace Lamassau.Web.UI.WebControls
{
	...
	/// <summary>
	/// ImageButton: Inherting the ImageButton ASP.NET control;
	/// Designed by Laith N Yousif.
	/// Developed by Laith N Yousif. 
	/// Date: Jan 2006.
	/// </summary>
	[ToolboxData("<{0}:ImageButton runat=server></{0}:ImageButton>"), PermissionSet(SecurityAction.Demand, Unrestricted=true)]
//	[DesignerAttribute(typeof(ImageButtonControlDesigner))]
	public class ImageButton: System.Web.UI.WebControls.ImageButton,ILamassauControl 
	{
	...
	namespace Design 
	{
//		public class ImageButtonControlDesigner  : image 
//		{
//	      
...
//				{
//				
//					ImageButton DesignImageButton = (ImageButton) Component;
//
//					// Capture the default output of the ImageButton control
//					StringWriter writer = new StringWriter();
//					HtmlTextWriter buffer = new HtmlTextWriter(writer);
//					DesignImageButton.RenderControl(buffer);			
