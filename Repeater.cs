...
namespace Lamassau.Web.UI.WebControls
{
	...
	/// <summary>
	/// Repeater: Inherting the Repeater ASP.NET control;
	/// Designed by Laith N Yousif.
	/// Developed by Laith N Yousif. 
	/// Date: Jan 2006.
	/// </summary>
	[ToolboxData("<{0}:Repeater runat=server></{0}:Repeater>"), PermissionSet(SecurityAction.Demand, Unrestricted=true)]
	[DesignerAttribute(typeof(RepeaterControlDesigner))]
	public class Repeater: System.Web.UI.WebControls.Repeater,ILamassauControl 
	{
	...
	namespace Design 
	{
		public class RepeaterControlDesigner  : RepeaterDesigner 
		{
...
//				{
//				
//					Repeater DesignRepeater = (Repeater) Component;
//
//					// Capture the default output of the Repeater control
//					StringWriter writer = new StringWriter();
//					HtmlTextWriter buffer = new HtmlTextWriter(writer);
//					DesignRepeater.RenderControl(buffer);			
